...
public class perference {
    ...
    public static String getMovieInfoFromJSON(String JSONSTR,String info_name) throws JSONException {
        JSONObject ReviewJson = new JSONObject(JSONSTR);
        return ReviewJson.getString(info_name);
    }
    public static void setMoviePerPage(int page) {moviePerPage = page;}
    public static int getMoviePerPage() {return moviePerPage;}
    ...
    public static void setSharemovietrailer(String s){sharemovietrailer = s;}
